...
const ELEMENT_DATA: DatiTabella[] = [
  {
      "id": 10001,
...
export class TabellaComponent {
  displayColumns: string[] = ['id', 'birthDate', 'firstName', 'lastName', 'gender', 'hireDate', 'action'];
  dataSource: MatTableDataSource<any> = new MatTableDataSource<any>(ELEMENT_DATA  );
  

  disabilita(index: number){
